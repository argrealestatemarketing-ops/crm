// Leads / Pipeline module — bilingual (AR / EN) constants.
// Labels are shown inline as "العربية / English".
...
// Stage color tokens (Tailwind classes for the column header + card accent).
